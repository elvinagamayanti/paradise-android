package com.example.paradiseppk.auth;
...
import com.example.paradiseppk.service.CustomUserDetailsService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private void setAuthenticationContext(String token, HttpServletRequest request) {
        ...
        // BONUS
        // Kode Untuk Mendapatkan Data User Yang Sudah Terautentikasi (Ada di Session)
...
//                String emailNow = userDetailsNow.getEmail(); // Ini akan berisi email atau username pengguna.
